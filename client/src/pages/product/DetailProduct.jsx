    ...
    <Box>
      ...
      <Box sx={{ display: "flex", minHeight: "85vh" }}>
        <Box sx={{ display: "flex", flex: 2, alignItems: "start" }}>
          ...
          {/* detail*/}
          <Box sx={{ flex: 1, p: 2, gap: 2, flexDirection: "column" }}>
            ...
            >
              ...
              {product.rating} dari ({product.reviews.length} reviews)
            </Typography>
            <Typography>{product.weight} gram</Typography>
        ...
        <Box sx={{ display: "flex", flex: 1 }}>Order</Box>
      </Box>
      <Footer />
    </Box>
  );
